class GithubNippou < Formula
  ...
  if Hardware::CPU.is_64_bit?
    url 'https://github.com/masutaka/github-nippou/releases/download/v4.0.0/github-nippou_v4.0.0_darwin_amd64.zip'
    sha256 '8b2fad1afd5c2a59965410866fad37e84c2d523c77a92c4102470f4712f1f829'
  else
    url 'https://github.com/masutaka/github-nippou/releases/download/v4.0.0/github-nippou_v4.0.0_darwin_386.zip'
